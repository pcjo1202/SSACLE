...
public class QVote extends EntityPathBase<Vote> {
    ...
    private static final long serialVersionUID = -299620036L;
    ...
    public final ssafy.com.ssacle.lunch.domain.QLunch lunch;

    public final ssafy.com.ssacle.user.domain.QUser user;

    public final DateTimePath<java.time.LocalDateTime> voteDay = createDateTime("voteDay", java.time.LocalDateTime.class);
    ...
    public QVote(Class<? extends Vote> type, PathMetadata metadata, PathInits inits) {
        ...
        this.lunch = inits.isInitialized("lunch") ? new ssafy.com.ssacle.lunch.domain.QLunch(forProperty("lunch")) : null;
